...
{
    public class RunPumpJob : IInvocable
    {
        ...
        public RunPumpJob(Settings settings)
        {
            _settings = settings;
        ...
        public async Task Invoke()
        {
            ...
            var msg = new MqttApplicationMessageBuilder().WithPayload("ON").WithTopic(_settings.MqttTopics.Control).Build();
